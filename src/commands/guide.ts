...
export function renderServiceGuide(): string {
  return [
    ...
    "- Provider collection decides what content is indexed; folder-external authority knowledge should be modeled as its own endpoint when UKP ownership matters.",
