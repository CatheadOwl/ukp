...
export function renderServiceGuide(): string {
  return [
    ...
    "   ukp get --endpoint your-endpoint-name <reference>",
    "",
    "Key boundary:",
    ...
    "- Dependencies do not change ordinary search/get. Only explicit search --recursive traverses direct authority/context dependencies.",
    ...
    "- Declarative dependencies live in the Service Manifest as [[dependencies]] entries; they do not change ordinary search/get, while explicit search --recursive traverses direct authority/context dependencies.",
...
export function renderServiceQmdGuide(): string {
  return [
    ...
    "- UKP only routes capability requests. This topic carries the journey; exact",
    "  flags and arguments belong to the relevant QMD subcommand help.",
    "",
    "Fast path for a simple knowledge folder:",
    "1. qmd init",
    "2. qmd collection add .",
    "3. qmd update",
    "4. qmd search \"keyword\"",
    "5. qmd get <reference> --no-line-numbers",
    "",
    ...
    "",
    "Exact flags and arguments come from the relevant QMD subcommand help, for example:",
    "  qmd init --help",
...
export function renderClientGuide(): string {
  return [
    ...
    "- One folder has one UKP role: .ukp/client.toml and .ukp/service.toml cannot coexist in the same folder.",
