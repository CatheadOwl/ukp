...
export function renderServiceGuide(): string {
  return [
    ...
    "  - declared dependencies: a Service Manifest can name related knowledge endpoints; this is declarative only;",
    ...
    "   declare them in the Manifest with --dependency <name> when you create it.",
    "",
    ...
    "- Declarative dependencies live in the Service Manifest; they describe related knowledge endpoints and do not change search/get behavior by themselves.",
